...
def config():
    ...
    parser.add_argument("--_4d", type=str, default="n", help="whether to use 4D mesh for training (y/N)")
    ...
    parser.add_argument("--lambda_", type=float, nargs='+', default=[2.0, 0.1, 1.0], help="the loss coefficients for Chamfer verts distance, point to mesh distance, and laplacian smooth term")
    ...
    parser.add_argument("--mr_json_dir", type=str,
                        default="/home/yd21/Documents/MorphiNet/dataset/dataset_task11_f0.json",    # less data less burden
                        # default="/home/yd21/Documents/MorphiNet/dataset/dataset_task10_f0.json",  # use only for 4d
    ...
    parser.add_argument("--use_ckpt", type=str, 
                        default=None,
                        # default="/mnt/data/Experiment/MorphiNet/Checkpoint/dynamic/cap--myo--f0--2024-07-10-0836/", 
...
def train(super_params):
    ...
    with wandb.init(config=config, mode=super_params.mode, project="MorphiNet", name=super_params.run_id):
        ...
        if super_params.save_on == "cap" and super_params._4d.lower() == 'y':
