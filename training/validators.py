...
class MorphiNetValidator:
    ...
    def validate_unet(self, epoch, modal):
        ...
        }, step=step, commit=True if modal == "mr" else False) # validate_unet is called twice for CT and MR
    ...
    def test_resnet(self, test_loader, modal):
        ...
        """
        print(f"\n--- RESNET TESTING ---")
        print(f"Phase: UNet + ResNet Only, Modal: {modal.upper()}")
    ...
    def test_full_pipeline(self, test_loader, modal):
        """
        ...
        print(f"Phase: UNet + ResNet + GSN, Modal: {modal.upper()}")
